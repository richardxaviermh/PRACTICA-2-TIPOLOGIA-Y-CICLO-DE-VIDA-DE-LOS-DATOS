...
En funcion de la informacion del dataset y de acuerdo a los analisis realizados, se concluye que:

- El data set consta de 5110 observaciones con 12 variables
- Las variables mas importantes en la incidencia de  padecer un AVC son la edad, la hipertension y los niveles de glucosa
